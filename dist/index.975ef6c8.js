...
var _easyScroll = require("easy-scroll");
var _easyScrollDefault = parcelHelpers.interopDefault(_easyScroll);
const refs = {
...
async function onFormElSubmit(e) {
    ...
    if (inputValue === "") {
        (0, _notiflixNotifyAio.Notify).warning(`введіть текст`);
        return;
    }
    const results = await (0, _fetchDefault.default)(inputValue, pageNumber);
...
function cardCreate(imgs) {
    const markup = imgs.map((img)=>(0, _templatesDefault.default)(img)).join("");
...
function onWindowScrole(entries) {
    ...
    entries.forEach(async (entry)=>{
        ...
        if (entry.isIntersecting && entry.intersectionRatio == 1) {
            ...
            if (remainder < 40) refs.infoTextEl.classList.remove("is-hidden");
            else refs.infoTextEl.classList.add("is-hidden");
        }
    });
}
...
},{"simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","notiflix/build/notiflix-notify-aio":"eXQLZ","./templates":"gOO7a","./fetch":"y31d7","easy-scroll":"2DBNL","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9ydBq":[function(require,module,exports) {
/*!
...
function cardTemplates({ webformatURL , largeImageURL , tags , likes , views , comments , downloads  }) {
    return `
...
async function cardFetchAxios(inputValue, page) {
    ...
    return await (0, _axiosDefault.default).get(`${URL}${filter}`).then((response)=>{
        return response.data;
    }).catch(function(error) {
        console.log(error);
    });
}
exports.default = cardFetchAxios;
...
},{"./../utils.js":"5By4s","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2DBNL":[function(require,module,exports) {
!function(e, t) {
    module.exports = t();
}(this, function() {
    return function(e1) {
        function t1(r) {
            ...
            return e1[r].call(o.exports, o, o.exports, t1), o.l = !0, o.exports;
        }
        var n1 = {};
        return t1.m = e1, t1.c = n1, t1.d = function(e, n, r) {
        ...
        function(e2, t2, n2) {
            ...
            var o1 = n2(1), i1 = r1(o1), u1 = n2(2), l1 = r1(u1), a1 = function(e) {
                var t = e.easingPreset, n = e.cubicBezierPoints, r = e.duration, o = e.runTime, u = o / r;
                return i1.default.hasOwnProperty(t) ? i1.default[t](u) : n && !isNaN(n.x1) && !isNaN(n.y1) && !isNaN(n.x2) && !isNaN(n.y2) && n.x1 >= 0 && n.x2 >= 0 ? (0, l1.default)({
                ...
                var t = e.isWindow, n = e.scrollableDomEle, r = e.elementLengthProp, o = e.initialScrollPosition, i = e.isHorizontalDirection, u = e.scrollLengthProp, l = e.direction, a = void 0;
                if (t) {
                ...
                var t = e3.scrollableDomEle, n = e3.onAnimationCompleteCallback, r2 = e3.direction, o = e3.onRefUpdateCallback, i = e3.duration, u = e3.cubicBezierPoints, l = e3.easingPreset, s2 = e3.scrollAmount, f = null, d = null, p1 = null, m1 = null, x = t === window, v = [
                    "left",
                    "right"
                ].indexOf(r2) > -1, b = [
                    "right",
                ...
                v ? (d = x ? "scrollX" : "scrollLeft", m1 = x ? "innerWidth" : "clientWidth", p1 = "scrollWidth") : (d = x ? "scrollY" : "scrollTop", m1 = x ? "innerHeight" : "clientHeight", p1 = "scrollHeight");
                var y = t[d], h = c1({
                    isWindow: x,
                    scrollableDomEle: t,
                    elementLengthProp: m1,
                    initialScrollPosition: y,
                    isHorizontalDirection: v,
                    scrollLengthProp: p1,
                    direction: r2
                });
                !isNaN(s2) && s2 < h && (h = s2);
            ...
            t2.default = s1, e2.exports = t2.default;
        },
        function(e4, t, n) {
            "use strict";
        ...
        function(e5, t3, n3) {
            ...
            var r = function(e) {
                ...
                var t = e.percentTimeElapsed, n = e.x1, l = e.y1, a = e.x2, c = e.y2;
                return 1 - (n * r(t) + l * o(t) + a * i(t) + c * u(t));
            };
            t3.default = l2, e5.exports = t3.default;
        }
    ]);
});
